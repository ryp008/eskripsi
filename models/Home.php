...
class Home extends Model{
    ...
    public function find() {
        ...
        $this->crud->selectjoin1($this->tabel(),"mhsw.NIM, mhsw.Name, mhsw.KodeJurusan, tbl_judul.judul, tbl_judul.latar, tbl_judul.bahasa, tbl_judul.instansi, tbl_judul.status, tbl_judul.objek, tbl_judul.tgl_pengajuan", $join, null, 'tgl_pengajuan DESC', 5);
